...
The Ctex Studio REST API for accessing the data and the services of the Ctex network in a simple way. You can use this API to query and interact with the objects of the Ctex network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Ctex network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Ctex\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Ctex network |
...
| homeBridgeAddress | `String` | Bridge address on the Ctex network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Ctex network |
...
Community is a set of contracts and services. Members of the community are users of the Ctex network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Ctex network |
| homeTokenAddress | `String` | Address of the community token on the Ctex network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Ctex network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Ctex network |
...
Entity is an account on the Ctex network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Ctex network |
...
Tokens are compatible with the CTEX20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
