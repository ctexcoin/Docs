...
Ctex chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://ctexscan.com/address/0x4D7BA903B65EAc8Bcf687E1e54d69E8629eaf8dA) with the following params:
...
Some other useful functions on the [voting contract](https://ctexscan.com/address/0x4D7BA903B65EAc8Bcf687E1e54d69E8629eaf8dA) are:
