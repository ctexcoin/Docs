...
We will learn how to connect Ctex cash wallet to various fuse DApps through WalletConnect feature and add liquidity to Fuseswap through Ctex cash wallet.
...
Open your Ctex cash wallet on your phone and the interface shown will be similar to the one shown in the image below.
...
Now click on “Pool” and then on “Add liquidity”. Select CTEX as your first token and fUSD as the second token from the dropdown. Enter the amount of CTEX you want to provide the liquidity for and the corresponding amount of fUSD that should be added will automatically show up according to the price of CTEX.  
...
Once the transaction is confirmed on-chain, click on “Supply” and approve the transaction. You will receive the liquidity pool tokens on your wallet which can be checked under tokens through [www.ctexscan.com](http://www.ctexscan.com/) on your wallet address.
