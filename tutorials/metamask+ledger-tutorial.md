...
We will learn how to connect Ledger to Metamask and use it on Ctex network after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change to “Ctex network” and perform the transactions on Ctex network through your Ledger device.

Note: To learn how to add Ctex network RPC follow [this link.](https://docs.ctexscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask)
