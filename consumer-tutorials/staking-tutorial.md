---
description: This tutorial will explain how to delegate/stake/unstake your CTEX.
---

# Staking tutorial

Note: You can only stake CTEX which is on Ctex network. Please make sure you have changed into Ctex network in Metamask while doing any transactions on staking UI. 

How to Stake Ctex:

**Step 1:**

Navigate to staking.ctexscan.com and login to your wallet through metamask. Make sure you are on Ctex network. If you are not please follow the instructions [**here**](https://docs.ctexscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of CTEX you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
