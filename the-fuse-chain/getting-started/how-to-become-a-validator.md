...
[Any entity that is holding the Ctex token can run a node](../consensus-contracts/stake-delegate-and-withdraw.md#stake) that approves transaction in the network and in doing so receive rewards in the form of Ctex token \(CTEX\).
...
[You can delegate you Ctex token to a validator](../consensus-contracts/stake-delegate-and-withdraw.md#delegate) of your choosing. Not everybody that wants to earn rewards need to be a validator! Any token holder can delegate their Ctex token to a validator to earn rewards through the validator.
