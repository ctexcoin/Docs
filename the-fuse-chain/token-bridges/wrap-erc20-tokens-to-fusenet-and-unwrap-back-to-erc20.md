---
description: Steps to transfer/wrap CTEX20 tokens from Ethereum to Fusenet
---

# Bridge for CTEX20 tokens

Please use this tutorial at your own risk as it involves using Etherscan UI/Ctex explorer to relay the tokens.
